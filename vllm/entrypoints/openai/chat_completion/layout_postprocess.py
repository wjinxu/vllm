"""Verbatim port of minicpmv-ocr's utils/layout_postprocess_utils.py.
...
def _to_numpy(value) -> np.ndarray:
    ...
    Lets the torch and onnx layout providers share this post-processing.
    """
...
def apply_layout_postprocess(
    ...
    for img_idx, result in enumerate(raw_results):
        ...
        order_seq = _to_numpy(result["order_seq"])
